package co.impactstd.test_android_fingerprint;
 ...
 */
public class EventHandler extends FingerprintManager.AuthenticationCallback{
    ...
    public void onAuthenticationSucceeded(
        ...
        Intent i = appContext.getPackageManager().getLaunchIntentForPackage("com.android.chrome");
